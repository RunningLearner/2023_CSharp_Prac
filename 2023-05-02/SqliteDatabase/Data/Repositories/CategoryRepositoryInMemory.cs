namespace Category
{
    public class CategoryRepositoryInMemory : ICategoryRepository<CategoryModel>
    {
        ...
        public List<CategoryModel> Paging(int pageNumber = 1, int pageSize = 10)
        {
            return
                _categories
